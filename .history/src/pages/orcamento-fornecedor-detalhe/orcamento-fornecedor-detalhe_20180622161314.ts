...
export class OrcamentoFornecedorDetalhePage {
  ...
  findOrcamentosDetalhes() {
    try {
      ...
      this.cockpitCotacaoService.detalhaCotacaoByIdCotacao(this.cotacaoFornecedorEntity)
  ...
  showAlert() {
    let alert = this.alertCtrl.create({
      ...
      subTitle: 'Ao aceitar o orçamento, é necessário informar o valor do serviço na lista de serviços abaixo.',
      buttons: ['OK']
    });
    alert.present();
  }
  ...
  aprovarCotacao() {
    try {
      ...
      if (this.respostaServicoForm.valid) {
        ...
        // fazer um for quando vier mais de um serviço
